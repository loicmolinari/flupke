...
// FMBitmapText renders a monospaced bitmap Latin-1 encoded text (128
...
class FLUPKE_METRICS_PRIVATE_EXPORT FMBitmapText
{
public:
    FMBitmapText();
    ~FMBitmapText();
    ...
    // Binds the FMBitmapText's shader program. Must be called prior to
