...
// QMBitmapText renders a monospaced bitmap Latin-1 encoded text (128
...
class QUICKEN_METRICS_PRIVATE_EXPORT QMBitmapText
{
public:
    QMBitmapText();
    ~QMBitmapText();
    ...
    // Binds the QMBitmapText's shader program. Must be called prior to
