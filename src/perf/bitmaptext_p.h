...
// QPBitmapText renders a monospaced bitmap Latin-1 encoded text (128
...
class QUICKEN_PERF_PRIVATE_EXPORT QPBitmapText
{
public:
    QPBitmapText();
    ~QPBitmapText();
    ...
    // Binds the QPBitmapText's shader program. Must be called prior to
